<template>
    <Select ref="select" v-bind="$attrs"  :multiple="multiple" class="ivu-tree-select" :class="classes" 
        :transfer-class-name="transferClassName" @on-change="handleChange" @on-open-change="handleOpenChange"
        :transfer="transfer" hideNotFound>
        <Tree :data="data" :multiple="multiple" @on-select-change="handleSelectNode" @on-check-change="handleSelectNode"
            check-strictly :show-checkbox="multiple && showCheckbox" check-directly :load-data="loadData"></Tree>
    </Select>
</template>
<script>
