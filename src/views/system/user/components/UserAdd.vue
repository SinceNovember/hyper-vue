        ...
        <Form :model="userInfo" ref="formValidate" :rules="ruleValidate" label-position="top" :hide-required-mark=true>
            ...
            <Row>
                ...
                <template v-if="userInfo.id">
                    <FormItem label="密码">
                        <Input value="************" disabled type="password"></Input>
                    </FormItem>
                </template>
                <template v-else>
            ...
            <Row :gutter="24">
                ...
                <Col span="12">
                <FormItem label="角色">
                    <Select v-model="userInfo.roleIds" multiple>
                        <Option v-for="item in roleOptions" :value="item.value" :key="item.value">{{ item.label }}
                        </Option>
                    </Select>
                </FormItem>
                </Col>
...
import { fetchRoleOptionModel } from '@/api/role'
